                    ...
                    <slick ref="slick" :options="slickOptions">
                        <div v-if="homeBanners" v-for="banner in homeBanners">
                            <router-link v-if="banner.url" :to="banner.url" class="">
                                ...
                                <div class="banner_image" v-bind:style="{ backgroundImage: 'url(https://placehold.it/1920x400)' }"></div>
                               
                            </router-link>
                            <!--<div v-else class="banner_image" v-bind:style="{ backgroundImage: 'url(' + banner.image_url + ')' }"></div>-->
                            <div v-else class="banner_image" v-bind:style="{ backgroundImage: 'url(https://placehold.it/1920x400)' }"></div>
                        </div>
                    </slick>
                ...
                <div class="main_container">
                    <div v-if="featureItems" class="feature_item_container">
                        <div v-for="item in featureItems" class="feature_item">
                            ...
                            <img src="//codecloud.cdn.speedyrails.net/sites/5a835c386e6f646ad8310000/image/png/1518461604000/Stores Directory.png" />
                        </div>
                    </div>
